...
frame_cima.grid_columnconfigure((0,3), weight=1) 
...
def atualizar_precos(): 
        ...
        try:
            ...
            l_brl_formatado= f"R$ {p_brl:,.2f}".replace(",", "X").replace(".", ",").replace("X", ".")
            l_brl.configure(text=f"R$ {l_brl_formatado} {seta_brl}", text_color=cor_brl)
